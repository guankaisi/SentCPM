...
from senteval.sts import STS12Eval, STS13Eval, STS14Eval, STS15Eval, STS16Eval, STSBenchmarkEval, SICKRelatednessEval, STSBenchmarkFinetune,CSTSEval
    ...
    def eval(self, name):
        ...
        if name == 'CR':
            ...
            self.evaluation = STSBenchmarkEval(tpath + '/downstream/STS/STSBenchmark', seed=self.params.seed)
             ...
             self.evaluation = CSTSEval(tpath + '/downstream/STS/CSTS', seed=self.params.seed)
